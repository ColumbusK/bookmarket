...
const BookPage = () => {
  ...
  const [bookInfo, setBookInfo] = useState({
    ...
    "title": "经济学人-20240413",
    "type": "TE",
    "coverUrl": "https://freemagazines.top/wp-content/uploads/2024/04/The-Economist-April-13th-19th-2024.webp",
        ...
        <div className="flex flex-row justify-center items-center w-full h-[70vh] ">
          ...
          <div className="flex flex-col justify-between items-start min-w-80 min-h-[400px] bg-gray-100 p-2 rounded-md">
            <div className="w-full text-left">
              ...
              <div>
                <p><span className="text-gray-600">上传者</span> <a href="" className="hover:border-b border-gray-700">{bookInfo.user}</a></p>
              </div>
            </div>
            <div
              className="flex justify-center w-full mt-4 mb-4 "
            >
              <img src="https://knightnewstands.com/magzines/magzines/QRMorse.jpg" alt="打赏二维码" className="w-56 h-56" />
            </div>
            <div className="w-full flex flex-col justify-start">
              ...
              <div className="flex justify-between w-full">
                <a href={bookInfo.panUrl} download="downloaded_file.pdf">
                  <Button size="lg">
                    <FileDownIcon className="mr-1 h-4 w-4" />直接下载
                  </Button>
                </a>
                <Button size="lg">
                  <DownloadCloud className="mr-1 h-4 w-4" />云盘链接
                </Button>
              </div>
            </div>
          </div>
